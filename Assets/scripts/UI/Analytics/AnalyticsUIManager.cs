...
public class AnalyticsUIManager : GenericObjectPool<AnalyticsUIView>
{
  ...
  internal void PopulateAnalyticsUI()
  {
    ...
    for (int i = 0; i < records.Count; i++)
    {
      ...
      recordUI.Setup(username,
          recordData.created_at,
          recordData.bet_amount,
          recordData.multiplier,
          recordData.win_amount,
          recordData.round_details.crashPoint);

      // ✅ Optional small animation for nicer table refresh
