...
namespace AdvancedInputFieldPlugin
{
	...
	public class InputFieldDropdown: Selectable
	{
		protected internal class DropdownItem: MonoBehaviour, ICancelHandler
		{
            ...
            [SerializeField]
            private bool m_disabledText = true;
            ...
            public bool disabledText { get { return m_disabledText; } set { m_disabledText = value; } }
		...
		public class OptionData
		{
            ...
            public bool _disabledText { get { return disabledText; } set { disabledText = value; } }
            ...
            public OptionData(string text,bool _DisabledText)
            {
                this.text = text;
                this._disabledText = _DisabledText;
                //Debug.Log("_disabledText " + _disabledText);
            }
        ...
        [SerializeField]
        private bool m_disabledImage;

        /// <summary>
        /// The Image component to hold the image of the item
        /// </summary>
        public bool disabledImage { get { return m_disabledImage; } set { m_disabledImage = value; } }
		...
		private void SetupTemplate()
		{
            ...
            item.disabledText = m_disabledImage;
		...
		private void CreateOptions()
		{
			...
			for(int axis = 0; axis < 2; axis++)
			{
				...
				outside = false; //Force dropdown to render above inputfield
		...
		private DropdownItem AddItem(OptionData data, bool selected, DropdownItem itemTemplate, List<DropdownItem> items)
		{
            ...
            item.disabledText = data._disabledText;

            //Debug.Log(".......disabledText ....." + item.disabledText);
            if (item.disabledText)
            {
                item.text.color = new Color(1f, 1f, 1f, 0.2f);
                item.image.color =new Color(0, 0, 0, 0.5f) ;
            }
            else
            {
